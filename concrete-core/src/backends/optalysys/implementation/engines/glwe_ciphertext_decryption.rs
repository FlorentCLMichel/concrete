...
/// # Description:
/// Implementation of [`GlweCiphertextDecryptionEngine`] for [`OptalysysEngine`] that operates on 32 bits
/// integers.
...
/// # Description:
/// Implementation of [`GlweCiphertextDecryptionEngine`] for [`OptalysysEngine`] that operates on 64 bits
/// integers.
