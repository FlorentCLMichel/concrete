...
use crate::backends::optalysys::private::crypto::glwe::GlweCiphertext as ImplGlweCiphertext;
...
/// # Description:
/// Implementation of [`GlweCiphertextEncryptionEngine`] for [`OptalysysEngine`] that operates on 32 bits
/// integers.
...
/// # Description:
/// Implementation of [`GlweCiphertextEncryptionEngine`] for [`OptalysysEngine`] that operates on 64 bits
/// integers.
