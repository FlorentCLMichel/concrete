...
use crate::backends::optalysys::private::crypto::gsw::GswCiphertext;
use crate::backends::optalysys::private::crypto::lwe::{LweCiphertext, LweList};
    ...
    Kind: KeyKind,
{
    ...
    /// use concrete_core::backends::optalysys::private::crypto::gsw::GswCiphertext;
    /// use concrete_core::backends::optalysys::private::crypto::secret::generators::{
    ///     EncryptionRandomGenerator, SecretRandomGenerator,
    /// };
