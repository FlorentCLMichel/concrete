...
use crate::backends::optalysys::private::math::decomposition::DecompositionLevel;
...
impl<Cont> GgswLevelMatrix<Cont> {
    ...
    /// ```rust
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::backends::optalysys::private::crypto::ggsw::GgswLevelMatrix;
    /// use concrete_core::backends::optalysys::private::math::decomposition::DecompositionLevel;
...
impl<Cont> GgswLevelRow<Cont> {
    ...
    /// ```rust
    /// use concrete_commons::parameters::{GlweSize, PolynomialSize};
    /// use concrete_core::backends::optalysys::private::crypto::ggsw::GgswLevelRow;
    /// use concrete_core::backends::optalysys::private::math::decomposition::DecompositionLevel;
