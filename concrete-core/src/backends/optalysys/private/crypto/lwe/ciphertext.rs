...
use crate::backends::optalysys::private::crypto::encoding::{Cleartext, CleartextList, Plaintext};
    ...
    Scalar: Copy,
{
    ...
    /// use concrete_core::backends::optalysys::private::crypto::lwe::LweCiphertext;
...
impl<Cont> LweCiphertext<Cont> {
    ...
    ///
    /// ```
    /// use concrete_core::backends::optalysys::private::crypto::lwe::{LweBody, LweCiphertext};
    ...
    ///
    /// ```
    /// use concrete_core::backends::optalysys::private::crypto::lwe::*;
    ...
    /// use concrete_commons::parameters::LweDimension;
    /// use concrete_core::backends::optalysys::private::crypto::encoding::*;
    /// use concrete_core::backends::optalysys::private::crypto::lwe::*;
    /// use concrete_core::backends::optalysys::private::crypto::secret::generators::{
    ///     EncryptionRandomGenerator, SecretRandomGenerator,
    /// };
    /// use concrete_core::backends::optalysys::private::crypto::secret::LweSecretKey;
    /// use concrete_core::backends::optalysys::private::crypto::*;
    ///
    ...
    /// use concrete_core::backends::optalysys::private::crypto::encoding::{Plaintext, PlaintextList};
    ...
    /// use concrete_core::backends::optalysys::private::math::polynomial::MonomialDegree;
