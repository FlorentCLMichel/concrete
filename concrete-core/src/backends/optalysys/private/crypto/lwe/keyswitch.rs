...
use crate::backends::optalysys::private::crypto::secret::generators::EncryptionRandomGenerator;
    ...
    Scalar: Copy,
{
    ...
    /// };
    /// use concrete_core::backends::optalysys::private::crypto::lwe::LweKeyswitchKey;
...
impl<Cont> LweKeyswitchKey<Cont> {
    ...
    /// ```ignore
    /// use concrete_core::backends::optalysys::private::crypto::{*, lwe::LweKeyswitchKey};
    /// use concrete_core::backends::optalysys::private::math::decomposition::{DecompositionLevelCount, DecompositionBaseLog};
    /// let ksk = LweKeyswitchKey::allocate(
    ///     0 as u8,
    ///     DecompositionLevelCount(10),
    ///     DecompositionBaseLog(16),
    ...
    /// ```ignore
    /// use concrete_core::backends::optalysys::private::crypto::{*, lwe::LweKeyswitchKey};
    /// use concrete_core::backends::optalysys::private::math::tensor::{AsRefTensor, AsMutTensor};
    /// use concrete_core::backends::optalysys::private::math::decomposition::{DecompositionLevelCount, DecompositionBaseLog};
    /// let mut ksk = LweKeyswitchKey::allocate(
    ///     0 as u8,
    ///     DecompositionLevelCount(10),
...
impl<Cont> LweKeyBitDecomposition<Cont> {
    ...
    ///
    /// ```rust,ignore
    /// use concrete_core::backends::optalysys::private::crypto::{*, lwe::LweKeyBitDecomposition};
