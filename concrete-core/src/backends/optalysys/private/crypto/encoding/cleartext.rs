...
impl<Cont> CleartextList<Cont> {
    ...
    /// ```rust
    /// use concrete_commons::parameters::CleartextCount;
    /// use concrete_core::backends::optalysys::private::crypto::encoding::CleartextList;
    ...
    ///
    /// ```rust
    /// use concrete_core::backends::optalysys::private::crypto::encoding::{Cleartext, CleartextList};
